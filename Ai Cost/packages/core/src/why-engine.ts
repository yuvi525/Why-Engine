import { RoutingContext, RoutingDecision, WHYExplanation } from '@vela/types';

export function generateWHY(decision: Omit<RoutingDecision, 'why'>, ctx: RoutingContext): WHYExplanation {
  ...
  switch (decision.reasonCode) {
    ...
    default:
      why = "Routing optimization applied.";
      impact = "Standard cost optimization.";
      action = `Routed to ${decision.model} on ${decision.provider}.`;
      decisionText = `Saved $${savings} vs GPT-4o.`;
      break;
  }
